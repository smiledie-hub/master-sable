        ...
        <div class="contact-form__wrapper cells">
            <div class="contact-form__cell cell">
                <div>
                    ...
                    <p class="contact-form__text">Наши наборы – гарантия лучшего качества и вашей индивидуальности. Мы уверены в своих материалах и готовы подтвердить их достоинства сертификатами и расширенной гарантией.</p>

                    <a href="#" class="catalog-contact-form__link link link--default link--weight">О продукции и гарантиях <span class="link__icon icon-long-arrow"></span></a>
                </div>
            </div>
            <div class="contact-form__cell cell">
                <form class="form">
